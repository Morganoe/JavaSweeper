...
public class Button {
    ...
    public boolean isMouseOver(Input input, int mouseX, int mouseY) {
	return mouseX > this.x && mouseX < this.x + this.width
		&& mouseY > this.y && mouseY < this.y + this.height;
    }
    ...
    private void fillRounded(Graphics g, int stringX, int stringY,
	    Color buttonColor, Color stringColor) {
    ...
    private void fillNonRounded(Graphics g, int stringX, int stringY,
	    Color buttonColor, Color stringColor) {
	Color prevColor = g.getColor();
	g.setColor(buttonColor);
